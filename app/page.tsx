    ...
    <PageShell>
      ...
      <section id="story" className="w-full py-32">
        <div className="grid gap-10 md:grid-cols-2 md:items-end">
          ...
          <div className="px-8 text-left md:px-10">
      ...
      <section id="flow" className="w-full py-32">
        <div className="flex flex-col gap-6 md:h-160 md:flex-row md:justify-between md:gap-0">
          <div className="flex w-full flex-col gap-6 px-8 text-left md:h-full md:w-[48%] md:justify-between md:px-10">
            <div className="flow-details-block flex flex-col gap-4">
              <h2 className="font-serif text-3xl text-foreground/90 md:text-4xl">
                Etkinlik Detayları
              </h2>
            ...
            <div className="flow-schedule-block flex flex-col gap-4">
      ...
      <section id="rsvp" className="w-full py-32">
        <div className="grid items-center gap-10 md:grid-cols-2">
          ...
          <div className="flex h-128 w-full flex-col gap-6 px-8 py-6 text-left md:h-160 md:justify-between md:gap-0 md:pb-0 md:pl-[35px] md:pr-0 md:pt-0">
            <div>
              <h2 className="font-serif text-3xl text-foreground/90 md:text-4xl">
